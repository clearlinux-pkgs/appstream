...
cp %{_builddir}/appstream-0.12.9/LICENSE.GPLv2 %{buildroot}/usr/share/package-licenses/appstream/db95910cb27890d60e596e4c622fc3eeba6693fa
cp %{_builddir}/appstream-0.12.9/LICENSE.LGPLv2.1 %{buildroot}/usr/share/package-licenses/appstream/7fab4cd4eb7f499d60fe183607f046484acd6e2d
...
%files extras
%defattr(-,root,root,-)
/usr/lib64/libAppStreamQt.so.0.12.9
/usr/lib64/libAppStreamQt.so.2

%files lib
%defattr(-,root,root,-)
/usr/lib64/libappstream.so.0.12.9
