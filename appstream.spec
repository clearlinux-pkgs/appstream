...
Version  : 0.15.4
Release  : 31
URL      : https://github.com/ximion/appstream/archive/v0.15.4/appstream-0.15.4.tar.gz
Source0  : https://github.com/ximion/appstream/archive/v0.15.4/appstream-0.15.4.tar.gz
...
%prep
%setup -q -n appstream-0.15.4
cd %{_builddir}/appstream-0.15.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653277610
...
cp %{_builddir}/appstream-0.15.4/COPYING %{buildroot}/usr/share/package-licenses/appstream/7fab4cd4eb7f499d60fe183607f046484acd6e2d
cp %{_builddir}/appstream-0.15.4/tests/samples/compose/Noto.LICENSE %{buildroot}/usr/share/package-licenses/appstream/d0f13df6b8f332b284e46d6bc228489e6115eda7
...
%files extras
%defattr(-,root,root,-)
/usr/lib64/libAppStreamQt.so.0.15.4
/usr/lib64/libAppStreamQt.so.2

%files lib
%defattr(-,root,root,-)
/usr/lib64/libappstream.so.0.15.4
