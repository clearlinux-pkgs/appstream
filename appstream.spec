...
Source0  : https://github.com/ximion/appstream/archive/v0.15.6/appstream-0.15.6.tar.gz
...
%prep
%setup -q -n appstream-0.15.6
cd %{_builddir}/appstream-0.15.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671813581
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libAppStreamQt.so.0.15.6
