...
Version  : 0.12.10
Release  : 15
URL      : https://github.com/ximion/appstream/archive/v0.12.10/appstream-0.12.10.tar.gz
Source0  : https://github.com/ximion/appstream/archive/v0.12.10/appstream-0.12.10.tar.gz
...
%prep
%setup -q -n appstream-0.12.10
cd %{_builddir}/appstream-0.12.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579627438
...
cp %{_builddir}/appstream-0.12.10/LICENSE.GPLv2 %{buildroot}/usr/share/package-licenses/appstream/db95910cb27890d60e596e4c622fc3eeba6693fa
cp %{_builddir}/appstream-0.12.10/LICENSE.LGPLv2.1 %{buildroot}/usr/share/package-licenses/appstream/7fab4cd4eb7f499d60fe183607f046484acd6e2d
...
%files extras
%defattr(-,root,root,-)
/usr/lib64/libAppStreamQt.so.0.12.10
/usr/lib64/libAppStreamQt.so.2

%files lib
%defattr(-,root,root,-)
/usr/lib64/libappstream.so.0.12.10
