...
Source0  : https://github.com/ximion/appstream/archive/APPSTREAM_0_12_6.tar.gz
...
%prep
%setup -q -n appstream-APPSTREAM_0_12_6
...
export LANG=C
export SOURCE_DATE_EPOCH=1551809132
...
%files extras
%defattr(-,root,root,-)
/usr/lib64/libAppStreamQt.so.0.12.6
/usr/lib64/libAppStreamQt.so.2

%files lib
%defattr(-,root,root,-)
%exclude /usr/lib64/libAppStreamQt.so.0.12.6
%exclude /usr/lib64/libAppStreamQt.so.2
/usr/lib64/libappstream.so.0.12.6
