...
%prep
%setup -q -n appstream-1.0.2
cd %{_builddir}/appstream-1.0.2
pushd ..
cp -a appstream-1.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708961294
unset LD_AS_NEEDED
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libAppStreamQt.so.1.0.2
/V3/usr/lib64/libappstream.so.1.0.2
/usr/lib64/libAppStreamQt.so.1.0.2
/usr/lib64/libAppStreamQt.so.3
/usr/lib64/libappstream.so.1.0.2
