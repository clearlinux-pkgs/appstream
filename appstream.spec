...
Source0  : https://github.com/ximion/appstream/archive/v1.0.1/appstream-1.0.1.tar.gz
...
%prep
%setup -q -n appstream-1.0.1
cd %{_builddir}/appstream-1.0.1
pushd ..
cp -a appstream-1.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703100398
unset LD_AS_NEEDED
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libAppStreamQt.so.1.0.1
/V3/usr/lib64/libappstream.so.1.0.1
/usr/lib64/libAppStreamQt.so.1.0.1
/usr/lib64/libAppStreamQt.so.3
/usr/lib64/libappstream.so.1.0.1
