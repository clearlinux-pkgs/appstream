...
Version  : 0.12.3
Release  : 1
URL      : https://github.com/ximion/appstream/archive/APPSTREAM_0_12_3.tar.gz
Source0  : https://github.com/ximion/appstream/archive/APPSTREAM_0_12_3.tar.gz
...
%prep
%setup -q -n appstream-APPSTREAM_0_12_3
...
export LANG=C
export SOURCE_DATE_EPOCH=1540858052
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libappstream.so.0.12.2
