...
Version  : 0.14.1
Release  : 19
URL      : https://github.com/ximion/appstream/archive/v0.14.1/appstream-0.14.1.tar.gz
Source0  : https://github.com/ximion/appstream/archive/v0.14.1/appstream-0.14.1.tar.gz
...
%prep
%setup -q -n appstream-0.14.1
cd %{_builddir}/appstream-0.14.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613614937
...
cp %{_builddir}/appstream-0.14.1/LICENSE.GPLv2 %{buildroot}/usr/share/package-licenses/appstream/db95910cb27890d60e596e4c622fc3eeba6693fa
cp %{_builddir}/appstream-0.14.1/LICENSE.LGPLv2.1 %{buildroot}/usr/share/package-licenses/appstream/7fab4cd4eb7f499d60fe183607f046484acd6e2d
cp %{_builddir}/appstream-0.14.1/tests/samples/compose/Noto.LICENSE %{buildroot}/usr/share/package-licenses/appstream/d0f13df6b8f332b284e46d6bc228489e6115eda7
...
%files extras
%defattr(-,root,root,-)
/usr/lib64/libAppStreamQt.so.0.14.1
/usr/lib64/libAppStreamQt.so.2

%files lib
%defattr(-,root,root,-)
/usr/lib64/libappstream.so.0.14.1
