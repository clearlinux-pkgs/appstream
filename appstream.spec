...
Version  : 1.0.3
Release  : 44
URL      : https://github.com/ximion/appstream/archive/v1.0.3/appstream-1.0.3.tar.gz
Source0  : https://github.com/ximion/appstream/archive/v1.0.3/appstream-1.0.3.tar.gz
...
%prep
%setup -q -n appstream-1.0.3
cd %{_builddir}/appstream-1.0.3
pushd ..
cp -a appstream-1.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714055627
unset LD_AS_NEEDED
...
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dstemming=false \
-Dapt-support=false \
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libAppStreamQt.so.1.0.3
/V3/usr/lib64/libappstream.so.1.0.3
/usr/lib64/libAppStreamQt.so.1.0.3
/usr/lib64/libAppStreamQt.so.3
/usr/lib64/libappstream.so.1.0.3
