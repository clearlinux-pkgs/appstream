...
Version  : 0.15.5
Release  : 32
URL      : https://github.com/ximion/appstream/archive/v0.15.5/appstream-0.15.5.tar.gz
Source0  : https://github.com/ximion/appstream/archive/v0.15.5/appstream-0.15.5.tar.gz
...
%prep
%setup -q -n appstream-0.15.5
cd %{_builddir}/appstream-0.15.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661473155
...
%files extras
%defattr(-,root,root,-)
/usr/lib64/libAppStreamQt.so.0.15.5
/usr/lib64/libAppStreamQt.so.2

%files lib
%defattr(-,root,root,-)
/usr/lib64/libappstream.so.0.15.5
