...
Version  : 1.0.5
Release  : 46
URL      : https://github.com/ximion/appstream/archive/v1.0.5/appstream-1.0.5.tar.gz
Source0  : https://github.com/ximion/appstream/archive/v1.0.5/appstream-1.0.5.tar.gz
...
%prep
%setup -q -n appstream-1.0.5
cd %{_builddir}/appstream-1.0.5
pushd ..
cp -a appstream-1.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745514591
unset LD_AS_NEEDED
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libAppStreamQt.so.1.0.5
/V3/usr/lib64/libappstream.so.1.0.5
/usr/lib64/libAppStreamQt.so.1.0.5
/usr/lib64/libAppStreamQt.so.3
/usr/lib64/libappstream.so.1.0.5
