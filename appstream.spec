...
%prep
%setup -q -n appstream-0.15.1
cd %{_builddir}/appstream-0.15.1
...
cp %{_builddir}/appstream-0.15.1/LICENSE.GPLv2 %{buildroot}/usr/share/package-licenses/appstream/db95910cb27890d60e596e4c622fc3eeba6693fa
cp %{_builddir}/appstream-0.15.1/LICENSE.LGPLv2.1 %{buildroot}/usr/share/package-licenses/appstream/7fab4cd4eb7f499d60fe183607f046484acd6e2d
cp %{_builddir}/appstream-0.15.1/tests/samples/compose/Noto.LICENSE %{buildroot}/usr/share/package-licenses/appstream/d0f13df6b8f332b284e46d6bc228489e6115eda7
