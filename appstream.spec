...
%prep
%setup -q -n appstream-0.12.11
cd %{_builddir}/appstream-0.12.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599070484
...
cp %{_builddir}/appstream-0.12.11/LICENSE.GPLv2 %{buildroot}/usr/share/package-licenses/appstream/db95910cb27890d60e596e4c622fc3eeba6693fa
cp %{_builddir}/appstream-0.12.11/LICENSE.LGPLv2.1 %{buildroot}/usr/share/package-licenses/appstream/7fab4cd4eb7f499d60fe183607f046484acd6e2d
cp %{_builddir}/appstream-0.12.11/docs/style/static/js/HighlightJS.LICENSE %{buildroot}/usr/share/package-licenses/appstream/00990dad3f28f5503fad9835bd7291524301574c
...
%files extras
%defattr(-,root,root,-)
/usr/lib64/libAppStreamQt.so.0.12.11
/usr/lib64/libAppStreamQt.so.2

%files lib
%defattr(-,root,root,-)
/usr/lib64/libappstream.so.0.12.11
/usr/lib64/libappstream.so.4

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/appstream/00990dad3f28f5503fad9835bd7291524301574c
